...
var debugLog = flag.Bool("assembly_debug_log", false, "If true, the github.com/mistsys/gopacket/tcpassembly library will log verbose debugging information (at least one line per packet)")
