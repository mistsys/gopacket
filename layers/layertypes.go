...
var (
	...
	LayerTypeOmniPeek                     = gopacket.RegisterLayerType(142, gopacket.LayerTypeMetadata{Name: "OmniPeek", Decoder: gopacket.DecodeFunc(decodeOmniPeek)})
	LayerTypeCiscoAP                      = gopacket.RegisterLayerType(143, gopacket.LayerTypeMetadata{Name: "CiscoAP", Decoder: gopacket.DecodeFunc(decodeCiscoAP)})
)
